...
#define MyAppName "Elve Generic Network Server Driver"
...
AppId={{320BE8D5-5FC4-4A37-A803-FD3E3762AA9A}
AppName={#MyAppName}
...
OutputBaseFilename=Elve Generic Network Server Driver 1.0
Compression=lzma
...
[Files]
Source: "..\..\src\Noesis.Elve.GenericNetworkServerDriver\bin\Release\Noesis.Elve.GenericNetworkServerDriver.dll"; DestDir: "{%PROGRAMDATA}\Codecore Technologies\Elve\DeviceDrivers\Compiled"; Flags: ignoreversion
